...
export default {
  ...
  created() {
    ...
    this.allData = JSON.stringify({
      ...
      dbPassword: sessionStorage.getItem('dbPassword'),
      dbIp: sessionStorage.getItem('dbIp'),
      slaveIp: sessionStorage.getItem('slaveIp'),
      gameIp: sessionStorage.getItem('gameIp'),
      rw: sessionStorage.getItem('rw'),
      frontIp: sessionStorage.getItem('frontIp'),
    });

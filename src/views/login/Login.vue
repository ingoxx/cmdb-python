  ...
  <div class="login-color">
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="0" class="login-f">
      ...
      <el-form-item prop="username">
        <el-input type="text" prefix-icon="el-icon-user" v-model="ruleForm.username" autocomplete="off" placeholder="用户"></el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input type="password" prefix-icon="el-icon-lock" v-model="ruleForm.password" autocomplete="off" placeholder="密码" show-password @keyup.enter.native="submitForm('ruleForm')"></el-input>
      </el-form-item>
            ...
            this.$router.push(
              { name: 'mfa', 
                params: { user: res.data.user, 
                          mfaimg: res.data.mfaimg,
                          mfasatus: res.data.mfasatus
                        }, 
              })
            this.loginStatus = false;
          } else {
